...
import csu.liutao.ffmpegdemo.audios.AudioDecoder
import java.io.File

class RecordAdapter(var context: Activity): RecyclerView.Adapter<RecordAdapter.ViewHolder>(), AudioDecoder.FinishListener {
